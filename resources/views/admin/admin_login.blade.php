            ...
            <p class="alert-danger">
              ...
              <form method="post" action="{{url('/adminlogin')}} ">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input" name="admin_email" placeholder="Enter Email">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input type="text" class="form-control p_input" name="admin_password" placeholder="Enter password">
                </div>
