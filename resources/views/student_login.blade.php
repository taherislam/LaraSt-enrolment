...
<head>
  <!-- Required meta tags -->
  <meta charset="utf-8">
  <meta name="viewport" content="{{asset('/width=device-width, initial-scale=1, shrink-to-fit=no')}}">
            ...
            <p class="alert-danger">
              ...
              <form method="post" action="{{url('/studentlogin')}} ">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control p_input" name="student_email" placeholder="Enter Email">
                </div>
                <div class="form-group">
                  <label>Password *</label>
                  <input type="password" class="form-control p_input" name="student_password" placeholder="Enter password">
                </div>
